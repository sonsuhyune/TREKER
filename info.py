...
class Info:
    ...
    def __init__(self, args):
        ...
        self.DEVICE_GPU = "cuda:{}".format(args.local_rank)
    ...
    def load_DocRED(self):
        ...
        self.FILE_CORPUSES = {self.MODE_TEST: self.FILE_CORPUS_TEST}
        self.FILE_CORPUSES = {self.MODE_TRAIN: self.FILE_CORPUS_TRAIN, self.MODE_DEV: self.FILE_CORPUS_DEV,
                                      self.MODE_TEST: self.FILE_CORPUS_TEST}
        ...
        self.FILE_INPUTS = {self.MODE_TRAIN: self.FILE_INPUT_TRAIN, self.MODE_DEV: self.FILE_INPUT_DEV,
                            self.MODE_TEST: self.FILE_INPUT_TEST}
        ...
        self.FILE_RESULTS = {self.MODE_TRAIN: self.FILE_RESULT_TRAIN, self.MODE_DEV: self.FILE_RESULT_DEV,
                             self.MODE_TEST: self.FILE_RESULT_TEST}
        ...
        self.FILE_TRUTH_TEST = os.path.join(self.DIR_DATASET_PRO, f'{self.MODE_TEST}_truth.pkl')
        self.FILE_TRUTHS = {self.MODE_TRAIN: self.FILE_TRUTH_TRAIN, self.MODE_DEV: self.FILE_TRUTH_DEV, self.MODE_TEST: self.FILE_TRUTH_TEST}
